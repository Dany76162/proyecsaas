...
const fields: { key: string; label: string; format?: (u: MasterplanUnit) => string }[] = [
    ...
    { key: "precio", label: "Precio", format: (u) => u.precio ? formatCurrency(u.precio, u.moneda || "USD") : "—" },
    { key: "precioM2", label: "Precio/m²", format: (u) => u.precio && u.superficie ? formatCurrency(Math.round(u.precio / u.superficie), u.moneda || "USD") : "—" },
