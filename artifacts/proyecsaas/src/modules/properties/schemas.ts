...
export const updatePropertySchema = z.object({
  ...
  province: z.preprocess(emptyStringToNull, z.string().trim().max(120).nullable()),
  ...
  coveredSurfaceM2: z.preprocess(stringNumberToNullableInt, z.number().int().nonnegative().nullable()),
  totalSurfaceM2: z.preprocess(stringNumberToNullableInt, z.number().int().nonnegative().nullable()),
  parkingSpots: z.preprocess(stringNumberToNullableInt, z.number().int().nonnegative().nullable()),
  yearBuilt: z.preprocess(stringNumberToNullableInt, z.number().int().nonnegative().nullable()),
...
export const reviewImportedPropertySchema = z.object({
  propertyId: z.string().trim().min(1),
});
...
export const updatePanoramaSettingsSchema = z.object({
  ...
  propertyId: z.string().min(1),
  label: z.string().max(100).optional(),
  roomName: z.string().max(100).nullable().optional(),
  floor: z.number().int().min(-5).max(80).optional(),
  positionX: z.number().min(-10000).max(10000).optional(),
  positionY: z.number().min(-10000).max(10000).optional(),
  positionZ: z.number().min(-10000).max(10000).optional(),
