  ...
  return (
    <>
      ...
      <SectionCard
        ...
        title="Canal de la Plataforma (Compartido)"
        description="Por defecto, tu inmobiliaria usa el número oficial de RaicesPilot. Los leads que escriban aquí se rutean automáticamente a tu panel."
      >
          ...
          {tenantChannels.length > 0 ? (
            <div className="grid grid-cols-1 gap-4">
              {tenantChannels.map((ch: any) => (
                <div key={ch.id} className="flex items-center justify-between p-4 rounded-2xl border border-slate-200 bg-white">
