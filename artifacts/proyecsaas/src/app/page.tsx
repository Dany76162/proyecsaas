...
type OrgList = Awaited<ReturnType<typeof listOrganizationsForUser>>;
...
export default async function HomePage() {
  ...
  try {
    ...
    console.error(
      JSON.stringify({ scope: "home", event: "ssr-error", message: err instanceof Error ? err.message : String(err) }),
    );
    // Degrade gracefully — render as unauthenticated
    sessionUser = null;
    organizations = [];
  }
